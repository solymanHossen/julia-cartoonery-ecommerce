...
<div id="payment" class="woocommerce-checkout-payment mt-12">
	...
	<div class="bg-white dark:bg-slate-800 rounded-[32px] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] border border-slate-100 dark:border-slate-700/50">
		...
		<div class="form-row place-order mt-8 pt-8 border-t border-slate-100 dark:border-slate-700/50">
			<noscript>
				<?php
