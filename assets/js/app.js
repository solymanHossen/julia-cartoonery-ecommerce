var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),s=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},c=(n,r,a)=>(a=n==null?{}:e(i(n)),s(r||!n||!n.__esModule?t(a,`default`,{value:n,enumerable:!0}):a,n));function l(e){let t=e(`#chat-toggle`),n=e(`#chat-window`),r=e(`#close-chat`),i=e(`#chat-icon-msg`),a=e(`#chat-icon-close`),o=e(`#chat-form`),s=e(`#chat-input`),c=e(`#chat-messages`),l=()=>{n.toggleClass(`hidden flex`),i.toggleClass(`hidden`),a.toggleClass(`hidden`)};t.length&&t.on(`click`,l),r.length&&r.on(`click`,l),o.length&&o.on(`submit`,function(e){e.preventDefault();let t=s.val().trim();if(!t)return;let n=`
        ...
        <div class="premium-toast-enter relative overflow-hidden flex items-start gap-4 bg-white/80 dark:bg-slate-900/80 backdrop-blur-3xl border border-white/60 dark:border-slate-700/50 rounded-[24px] p-4 pr-12 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.15)] dark:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.7)] transform transition-all duration-300 hover:scale-[1.02] hover:-translate-y-1 hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] dark:hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.9)] cursor-default">
            ...
            <div class="absolute -left-10 -top-10 w-32 h-32 ${i.glow} blur-[40px] rounded-full pointer-events-none transition-transform duration-1000 group-hover:scale-[1.5]"></div>
            <div class="absolute -right-10 -bottom-10 w-32 h-32 ${i.glow} opacity-60 blur-[40px] rounded-full pointer-events-none transition-transform duration-1000 group-hover:scale-[1.5]"></div>

            <!-- Icon Container with inner glow and hover spin -->
            <div class="flex items-center justify-center w-12 h-12 ${i.bg} ${i.color} rounded-[18px] shrink-0 shadow-inner border border-white/40 dark:border-white/10 relative z-10 overflow-hidden transition-all duration-300 group-hover:rotate-[15deg] group-hover:scale-110">
            ...
            <div class="flex flex-col relative z-10 pt-1 w-full">
                <p class="text-[1.05rem] font-bold text-slate-800 dark:text-white tracking-tight leading-tight mb-1 font-['Bubblegum_Sans',sans-serif]">${i.title}</p>
                <p class="text-[0.85rem] font-medium text-slate-600 dark:text-slate-300 leading-snug break-words pr-2">${e}</p>
            </div>
            ...
            <div class="absolute bottom-0 left-0 h-1.5 w-full bg-slate-100 dark:bg-slate-800/50 rounded-b-[24px] overflow-hidden">
                <div class="h-full ${i.progress} animate-shrink-${a} rounded-bl-[24px] shadow-[0_0_10px_rgba(0,0,0,0.2)]"></div>
            </div>
        </div>
    `;let s=(0,h.default)({text:e,duration:n,gravity:`top`,position:`right`,stopOnFocus:!0,className:`premium-glass-toast-wrapper`,style:{background:`transparent`,boxShadow:`none`,padding:`0`,margin:`0 0 16px 0`,pointerEvents:`none`},escapeMarkup:!1,node:o}),c=o.querySelector(`.toast-close-btn`);c&&c.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),s.hideToast()}),s.showToast()};window.showToast=g;var _=e=>{e(document).on(`click`,`.julias-wishlist-btn`,function(t){t.preventDefault();let n=e(this),r=n.data(`product-id`),i=n.find(`.wishlist-icon`);if(typeof juliasSettings>`u`||!juliasSettings.ajaxUrl){console.error(`Wishlist settings not found.`);return}n.hasClass(`is-loading`)||(n.addClass(`is-loading opacity-70 pointer-events-none`),i.addClass(`animate-pulse`),e.ajax({url:juliasSettings.ajaxUrl,type:`POST`,data:{action:`toggle_wishlist`,product_id:r,security:juliasSettings.nonce},success:function(t){n.removeClass(`is-loading opacity-70 pointer-events-none`),i.removeClass(`animate-pulse`),t.success?(t.data.is_added?(n.addClass(`text-[#FFB7C5]`),i.attr(`fill`,`currentColor`),g(`Added to your wishlist!`,`success`)):(n.removeClass(`text-[#FFB7C5]`),i.attr(`fill`,`none`),g(`Removed from your wishlist.`,`info`)),t.data.fragment&&e(`.julias-wishlist-count`).replaceWith(t.data.fragment)):g(t.data.message||`Failed to update wishlist.`,`error`)},error:function(){n.removeClass(`is-loading opacity-70 pointer-events-none`),i.removeClass(`animate-pulse`),g(`Network error occurred.`,`error`)}}))})};(function(e){e(document).ready(function(){u(e),d(e),l(e),f(e),p(e),m(e),_(e),e(document.body).on(`added_to_cart`,function(e,t,n,r){g(`Item added to your cart.`,`success`)})})})(jQuery);