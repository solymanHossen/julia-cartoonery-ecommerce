var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),s=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},c=(n,r,a)=>(a=n==null?{}:e(i(n)),s(r||!n||!n.__esModule?t(a,`default`,{value:n,enumerable:!0}):a,n));function l(e){let t=e(`#chat-toggle`),n=e(`#chat-window`),r=e(`#close-chat`),i=e(`#chat-icon-msg`),a=e(`#chat-icon-close`),o=e(`#chat-form`),s=e(`#chat-input`),c=e(`#chat-messages`),l=()=>{n.toggleClass(`hidden flex`),i.toggleClass(`hidden`),a.toggleClass(`hidden`)};t.length&&t.on(`click`,l),r.length&&r.on(`click`,l),o.length&&o.on(`submit`,function(e){e.preventDefault();let t=s.val().trim();if(!t)return;let n=`
        ...
        <div class="relative overflow-hidden flex items-center gap-4 bg-white/70 dark:bg-slate-900/50 backdrop-blur-2xl border border-white/50 dark:border-slate-700/50 rounded-[24px] p-4 pr-8 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.12)] dark:shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)]">
            <div class="absolute -left-6 -top-6 w-24 h-24 ${n?`bg-[#FFB7C5]/30`:`bg-red-500/20`} blur-2xl rounded-full pointer-events-none"></div>
            <div class="flex items-center justify-center w-11 h-11 ${i} rounded-2xl shrink-0 shadow-sm relative z-10">
                ${r}
            </div>
            <div class="flex flex-col relative z-10">
                <p class="text-[0.95rem] font-extrabold text-slate-800 dark:text-white tracking-tight leading-tight">${a}</p>
                <p class="text-[0.8rem] font-semibold text-slate-500 dark:text-slate-300 mt-0.5">${e}</p>
            </div>
        </div>
    `,(0,h.default)({text:e,duration:3e3,gravity:`top`,position:`right`,stopOnFocus:!0,className:`premium-glass-toast`,style:{background:`transparent`,boxShadow:`none`,padding:`0`},escapeMarkup:!1,node:o}).showToast()};window.showToast=g,(function(e){e(document).ready(function(){u(e),d(e),l(e),f(e),p(e),m(e),e(document.body).on(`added_to_cart`,function(e,t,n,r){g(`Item added to your cart.`,`success`)})})})(jQuery);