...
<section class="py-16 sm:py-20 relative overflow-hidden bg-white">
	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
		...
		<div class="text-center max-w-2xl mx-auto mb-16">
			...
			<h2 class="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 tracking-tight">
		...
		<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 sm:gap-8">
			...
			?>
				...
				<a href="<?php echo esc_url( $cat_link ); ?>" class="group flex flex-col items-center text-center outline-none">
					...
					<div class="relative w-36 h-36 sm:w-44 sm:h-44 rounded-full p-[6px] bg-gradient-to-br from-white/80 to-white/30 backdrop-blur-md shadow-[0_8px_32px_rgba(0,0,0,0.06)] hover:shadow-[0_20px_48px_rgba(255,147,171,0.25)] transition-all duration-500 ease-out group-hover:-translate-y-2 group-focus-visible:ring-4 ring-[#FF93AB]/50 ring-offset-2 z-10">
						
						<!-- Inner Image Container -->
						<div class="w-full h-full rounded-full overflow-hidden bg-white relative ring-1 ring-slate-900/5 group-hover:ring-[#FF93AB]/50 transition-all duration-500">
							...
							<div class="absolute inset-0 bg-gradient-to-t from-[#FF93AB]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none mix-blend-overlay"></div>
						</div>
					</div>

					<div class="mt-6 flex flex-col items-center transform transition-transform duration-500 group-hover:-translate-y-1">
						<h3 class="text-base sm:text-lg font-bold text-slate-800 group-hover:text-[#FF93AB] transition-colors duration-300">
							<?php echo esc_html( $category->name ); ?>
						</h3>
						<span class="inline-flex items-center mt-1.5 px-2.5 py-0.5 rounded-full bg-slate-50 text-[11px] font-bold text-slate-500 uppercase tracking-wider group-hover:bg-[#FF93AB]/10 group-hover:text-[#FF93AB] transition-colors duration-300">
